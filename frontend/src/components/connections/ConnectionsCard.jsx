    ...
    <div className="card bg-base-200 border border-base-300 shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden flex flex-col justify-between p-5 group hover:border-primary/20">
      ...
      <div className="flex gap-4 items-start">
        ...
        <div className="avatar shrink-0">
          <div className="w-16 h-16 rounded-full ring-2 ring-base-300 group-hover:ring-primary/40 transition-all overflow-hidden bg-base-300">
            <img 
      ...
      <div className="mt-5 pt-3 border-t border-base-300/40 w-full">
        <Link to={`/chat/${_id}`} className="block w-full">
          <button className="btn btn-primary btn-sm w-full h-10 rounded-xl font-bold tracking-wide shadow-md shadow-primary/10 group-hover:shadow-primary/20 transition-all duration-200 gap-1.5">
            <svg 
